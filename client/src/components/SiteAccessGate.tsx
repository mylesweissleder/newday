      ...
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          <div className="mx-auto h-20 w-20 bg-blue-600 rounded-full flex items-center justify-center">
            <svg style={{width: '40px', height: '40px'}} className="text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          <div>
            ...
            <div className="relative">
              ...
              >
                {showPassword ? (
                  <svg style={{width: '20px', height: '20px'}} className="text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
